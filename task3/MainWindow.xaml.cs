...
public partial class MainWindow : Window
{
    ...
    private void BrowseButtonClick(object sender, RoutedEventArgs e)
    {
        ...
        if (openFileDialog.ShowDialog() == true)
        {
            ...
            Type abstractClassType = assembly.GetType("FlyObjectLibrary.FlyObject");
    ...
    private void ClassListBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        ...
        {
            Assembly assem = typeof(FlyObject).Assembly;
    ...
    private void ExecuteConstructorButton_Click(object sender, RoutedEventArgs e)
    {
        if (_selectedType != null)
        {
            try
            {
                ...
                if (_createdInstance is Plane plane)
                {
                    plane.Runway += OnRunwayEvent;
                }
    ...
    private void OnRunwayEvent(object sender, Plane.OnRunwayEventArgs e)
    {
        MessageBox.Show($"{e.OnRunwayMessage}");
    }
